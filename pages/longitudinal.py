...
@callback(
        ...
        Input("raw-scatter-long","figure"),
        Input("raw-box-long","figure"),
        Input("raw-pca-long","figure"),
        Input("raw-clustergram-long","figure"),
        Input("raw-distplot-norm-long","figure"),
        Input("raw-distplot-kde-long","figure"),
        Input("combat-scatter-long","figure"),
        Input("combat-box-long","figure"),
        Input("combat-pca-long","figure"),
        Input("combat-clustergram-long","figure"),
        Input("combat-distplot-norm-long","figure"),
        Input("combat-distplot-kde-long","figure"),
        prevent_initial_call=True
)
def download_combat_plots(n_clicks,raw_scatter, raw_box, raw_pca, \
    ...
    return dcc.send_file("data:text/html;base64," + encoded,"combat_longitudinal_plot_report.html")
